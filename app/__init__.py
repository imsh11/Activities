...
from .api.cart_order_routes import cartOrder
...
app.register_blueprint(order_item_routes, url_prefix='/api/order')
app.register_blueprint(cartOrder, url_prefix='/api/cart')
